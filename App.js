...
function TabNavigator() {
  return (
    ...
    >
      <Tab.Screen name='InicioUser' component={InicioUser} options={{ headerShown: false,
     tabBarLabel: () => null,
      ...
      <Tab.Screen name='Favorito' component={Favorito} options={{ headerShown: false,
     tabBarLabel: () => null,
        tabBarIcon:({color,size})=>(
      ...
      <Tab.Screen name='PerfilUser' component={PerfilUser} options={{ headerShown: false,
     tabBarLabel: () => null,
        tabBarIcon:({color,size})=>(
